...
// ========== Lattice-Specific Handlers ==========

/// GET /v1/lattice/models - List Lattice models with detailed info
...
async fn root() -> Json<serde_json::Value> {
    Json(serde_json::json!({
        "name": "Lattice AI API",
        "version": env!("CARGO_PKG_VERSION"),
        "description": "OpenAI/Anthropic compatible API for Lattice blockchain AI models",
        "endpoints": {
            "openai": {
                "models": "/v1/models",
