...
export const ChatBot: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const welcomeMessage: ChatMessage = {
      id: 'welcome',
      role: 'system',
      content: 'Welcome to Lattice AI Chat! I can help you with:\n\n• AI model development and deployment\n• Smart contract code generation\n• Blockchain data analysis\n• IPFS storage management\n• General programming assistance\n\nWhat would you like to work on today?',
      timestamp: new Date()
    };
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const errorMessage: ChatMessage = {
        id: (Date.now() + 1).toString(),
        role: 'assistant',
        content: `I apologize, but I encountered an error: ${error}. Please try again or check your connection to the Lattice network.`,
        timestamp: new Date(),
        model: selectedModel
      };
      ...
      {showSettings && (
        <div className="settings-panel">
          ...
          <div className="setting-group">
            ...
            <textarea
              rows={3}
              defaultValue="You are a helpful AI assistant specialized in blockchain and AI development on the Lattice platform."
            />
          </div>
        </div>
      )}
