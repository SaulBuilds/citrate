...
# Complete hard reset of Citrate V3 blockchain
...
echo -e "${RED}╔══════════════════════════════════════════════════════════════════════╗${NC}"
echo -e "${RED}║           CITRATE V3 HARD RESET - COMPLETE CHAIN WIPE               ║${NC}"
echo -e "${RED}╚══════════════════════════════════════════════════════════════════════╝${NC}"
...
echo -e "\n${BLUE}[1/8] Killing all Citrate processes...${NC}"
...
# Clean Tauri cache
TAURI_CACHE="$HOME/Library/Caches/citrate-core"
...
GUI_LOCAL="gui/citrate-core/gui-data"
if [ -d "$GUI_LOCAL" ]; then
