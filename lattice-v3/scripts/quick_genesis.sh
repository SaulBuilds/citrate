...
# Lattice v3 Quick Genesis Startup Script
...
clear
echo -e "${CYAN}╔══════════════════════════════════════════════════════════════════════╗${NC}"
echo -e "${CYAN}║                 LATTICE V3 QUICK GENESIS STARTUP                    ║${NC}"
echo -e "${CYAN}╚══════════════════════════════════════════════════════════════════════╝${NC}\n"
...
rm -rf gui/lattice-core/src-tauri/gui-data 2>/dev/null || true
...
echo -e "• Core logs: tail -f /tmp/lattice_core.log"
echo -e "• GUI logs: tail -f /tmp/lattice_gui.log"
