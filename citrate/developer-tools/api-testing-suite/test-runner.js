...
/**
 * Citrate API Testing Suite
 * Comprehensive testing framework for Citrate blockchain APIs
 */
...
class LatticeTestRunner {
    ...
    async runBasicTests() {
        console.log('🚀 Starting Citrate API Basic Tests...\n');
    ...
    async runLatticeSpecificTests() {
        ...
        await this.test('Network Topology Test', async () => {
            try {
                const topology = await this.rpcCall('citrate_getNetworkTopology');
        ...
        await this.test('AI Inference API Test', async () => {
            try {
                const result = await this.rpcCall('citrate_runInference', [
                    'test_model_id',
                    { input: 'test_data' }
                ]);
    ...
    async run() {
        console.log('🚀 Citrate API Testing Suite');
