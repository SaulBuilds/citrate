...
echo -e "${CYAN}╔══════════════════════════════════════════════════════════════════════╗${NC}"
echo -e "${CYAN}║           LATTICE V3 FRESH TESTNET STARTUP                          ║${NC}"
echo -e "${CYAN}╚══════════════════════════════════════════════════════════════════════╝${NC}"

# Step 1: Ensure clean state
echo -e "\n${BLUE}[1/9] Ensuring clean state...${NC}"
if [ -d ".lattice-testnet" ] || [ -d "data" ]; then
...
echo -e "  Monitor logs:     ${CYAN}tail -f /tmp/lattice_testnet.log${NC}"
