#!/usr/bin/env python3
"""
Encrypted inference example for Lattice Python SDK
...
from lattice_sdk.crypto import KeyManager, EncryptionConfig
...
def main():
    ...
    # Connect to Lattice
    print(f"Connecting to Lattice at {RPC_URL}...")
    client = LatticeClient(rpc_url=RPC_URL, private_key=PRIVATE_KEY)
    ...
    try:
        ...
        from lattice_sdk.crypto import hash_model_data, verify_model_integrity
