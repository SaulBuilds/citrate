// citrate/core/api/src/dag_explorer.rs
...
use citrate_storage::chain::{BlockStore, ChainStore, TransactionStore};
...
impl DagExplorer {
    pub async fn new() -> Self {
        ...
        let devnet_config = NetworkConfig {
            ...
            explorer_port: 3001,
            data_dir: ".citrate-devnet".to_string(),
            is_active: false,
        ...
        let testnet_config = NetworkConfig {
            ...
            ws_endpoint: "ws://localhost:8546".to_string(),
            explorer_port: 3002,
            data_dir: ".citrate-testnet".to_string(),
            is_active: true,
            genesis_hash: Hash::zero(),
            block_time: 2,
            ghostdag_k: 18,
        ...
        let mainnet_config = NetworkConfig {
            ...
            ws_endpoint: "ws://localhost:8546".to_string(),
            explorer_port: 3000,
            data_dir: ".citrate-mainnet".to_string(),
            is_active: false,
            genesis_hash: Hash::zero(),
            block_time: 3,
            ghostdag_k: 50,
