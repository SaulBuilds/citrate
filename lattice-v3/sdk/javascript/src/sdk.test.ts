...
describe('LatticeSDK', () => {
  ...
  it('merges config defaults', () => {
    const sdk = new LatticeSDK({ rpcEndpoint: 'http://127.0.0.1:8545', chainId: 999 } as any);
    // @ts-ignore
  ...
  it('calls RPC with array params', async () => {
    const sdk = new LatticeSDK({ rpcEndpoint: 'http://127.0.0.1:8545', chainId: 1337 } as any);
