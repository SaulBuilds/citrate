...
impl SyncManager {
    ...
    fn calculate_tx_root(&self, transactions: &[lattice_consensus::types::Transaction]) -> Hash {
    ...
    fn calculate_block_hash(&self, header: &lattice_consensus::types::BlockHeader) -> Hash {
        use sha3::{Digest, Keccak256};
        let mut hasher = Keccak256::new();
