#!/usr/bin/env python3
"""
Basic usage example for Lattice Python SDK

This example demonstrates:
1. Connecting to Lattice network
...
def main():
    ...
    try:
        # Deploy model
        print("Deploying model to Lattice...")
