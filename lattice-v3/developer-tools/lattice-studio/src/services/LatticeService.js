...
export class LatticeService {
  ...
  async getModels() {
    try {
      return await this.rpcCall('lattice_getModels');
    } catch (error) {
      // Fallback if custom method not available
      return [];
    }
  }
  ...
  async getModelInfo(modelId) {
    try {
      return await this.rpcCall('lattice_getModelInfo', [modelId]);
    } catch (error) {
  ...
  async deployModel(modelData) {
    try {
      return await this.rpcCall('lattice_deployModel', [modelData]);
    } catch (error) {
  ...
  async runInference(modelId, inputData) {
    try {
      return await this.rpcCall('lattice_runInference', [modelId, inputData]);
    } catch (error) {
  ...
  async getPeers() {
    try {
      return await this.rpcCall('lattice_getPeers');
    } catch (error) {
  ...
  async getNetworkTopology() {
    try {
      return await this.rpcCall('lattice_getNetworkTopology');
    } catch (error) {
  ...
  async getModelStats(modelId, timeRange = '24h') {
    try {
      return await this.rpcCall('lattice_getModelStats', [modelId, timeRange]);
    } catch (error) {
