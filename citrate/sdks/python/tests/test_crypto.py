...
class TestErrorScenarios:
    ...
    def test_decrypt_invalid_package(self):
        ...
        with pytest.raises(CitrateError, match="Data decryption failed"):
    ...
    def test_model_decryption_missing_metadata(self):
        ...
        with pytest.raises(CitrateError, match="Model decryption failed"):
    ...
    def test_derive_shared_key_invalid_pubkey(self):
        ...
        with pytest.raises(CitrateError, match="Key derivation failed"):
