...
pub static MEMPOOL_SIZE: Lazy<prometheus::GaugeVec> = Lazy::new(|| {
    register_gauge_vec!("lattice_mempool_size", "Current mempool size", &["class"])
