...
class RPCClient {
  ...
  async getDAGTips(): Promise<string[]> {
    try {
      return await this.sendRequest('lattice_getTips');
    } catch {
  ...
  async getBlueScore(blockHash: string): Promise<number> {
    try {
      const score = await this.sendRequest('lattice_getBlueScore', [blockHash]);
  ...
  async getBlueSet(blockHash: string): Promise<string[]> {
    try {
      return await this.sendRequest('lattice_getBlueSet', [blockHash]);
    } catch {
      return [];
    }
  }
  ...
  // Custom Lattice methods
  async getModelRegistry(): Promise<any[]> {
    try {
      return await this.sendRequest('lattice_getModels');
    } catch {
      return [];
    }
  }
  ...
  async deployModel(modelData: any): Promise<string> {
    try {
      return await this.sendRequest('lattice_deployModel', [modelData]);
    } catch (error) {
  ...
  async runInference(request: any): Promise<any> {
    try {
      return await this.sendRequest('lattice_runInference', [request]);
    } catch (error) {
