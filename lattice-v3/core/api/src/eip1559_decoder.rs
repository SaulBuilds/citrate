// lattice-v3/core/api/src/eip1559_decoder.rs
...
impl Eip1559Decoder {
    ...
    pub fn decode_transaction(&self, tx_bytes: &[u8]) -> Result<Transaction, Eip1559Error> {
        ...
        // Convert to Lattice transaction format
    ...
    /// Convert EIP-1559 transaction to Lattice transaction format
    fn convert_to_lattice_transaction(
        ...
        // Convert addresses to Lattice PublicKey format (embed 20 bytes in 32-byte field)
