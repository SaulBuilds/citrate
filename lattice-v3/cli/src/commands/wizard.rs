//lattice-v3/cli/src/commands/wizard.rs
...
async fn model_deploy_wizard(config: &Config) -> Result<()> {
    ...
    println!("This wizard will guide you through deploying a model to Lattice.");
    println!();
    ...
    let description: String = Input::with_theme(&theme)
        ...
        .with_initial_text("AI model deployed via Lattice")
        .interact()?;
...
async fn dev_setup_wizard(_config: &Config) -> Result<()> {
    ...
    println!("This wizard will help you set up a Lattice development environment.");
    println!();
...
Solidity smart contract project for Lattice blockchain.
...
fn setup_python_project(name: &str, _use_templates: bool) -> Result<()> {
    ...
    let requirements = r#"lattice-sdk==0.1.0
torch>=1.9.0
numpy>=1.21.0
onnx>=1.10.0
"#;
