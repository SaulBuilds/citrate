...
# Lattice Frontends Deployment Script
...
main() {
    log "🚀 Starting Lattice frontends deployment..."
    ...
    deploy_frontend "Lattice Studio" "$DEVELOPER_TOOLS_DIR/lattice-studio"
...
case "${1:-deploy}" in
    ...
    *)
        ...
        echo "  studio:    Deploy Lattice Studio only"
