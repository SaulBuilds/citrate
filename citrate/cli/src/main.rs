...
#[command(
    name = "citrate",
    version,
    about = "Citrate v3 CLI - AI-native Layer-1 BlockDAG",
    long_about = None
)]
struct Cli {
    #[command(subcommand)]
    ...
    /// Config file path
    #[arg(short, long, global = true, env = "CITRATE_CONFIG")]
    config: Option<PathBuf>,

    /// RPC endpoint
    #[arg(short, long, global = true, env = "CITRATE_RPC")]
    rpc: Option<String>,
