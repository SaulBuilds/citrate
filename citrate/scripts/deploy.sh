...
# Citrate V3 Deployment Script
# Deploys the Citrate AI-native blockchain
...
echo "==========================================="
echo "       CITRATE V3 DEPLOYMENT SCRIPT"
echo "==========================================="
echo ""
...
echo ""
echo -e "${YELLOW}Building Citrate V3...${NC}"
echo ""
...
[Unit]
Description=Citrate V3 AI Blockchain
...
echo ""
echo -e "${YELLOW}Starting Citrate node...${NC}"
echo ""
...
if [ "$NETWORK" = "devnet" ]; then
    ...
    echo -e "${GREEN}✓${NC} Citrate node started (PID: $PID)"
    echo ""
...
echo ""
echo "Documentation: https://github.com/citrate-network/citrate"
echo ""