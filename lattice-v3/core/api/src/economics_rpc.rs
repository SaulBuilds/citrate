// lattice-v3/core/api/src/economics_rpc.rs

use futures::executor::block_on;
use jsonrpc_core::{IoHandler, Params, Value};
use lattice_economics::UnifiedEconomicsManager;
...
pub fn register_economics_methods(
    ...
    io_handler.add_sync_method("lattice_gasPrice", move |_params: Params| {
    ...
    io_handler.add_sync_method("lattice_getEconomicState", move |_params: Params| {
    ...
    io_handler.add_sync_method("lattice_getVotingPower", move |params: Params| {
        if let Some(economics) = &economics_vp {
            ...
            let address = lattice_execution::types::Address(addr_array);
    ...
    io_handler.add_sync_method("lattice_getStakeholderInfo", move |params: Params| {
    ...
    io_handler.add_sync_method("lattice_getRevenueHistory", move |_params: Params| {
    ...
    io_handler.add_sync_method("lattice_getToken", move |_params: Params| {
    ...
    io_handler.add_sync_method("lattice_getStakedBalance", move |params: Params| {
    ...
    io_handler.add_sync_method("lattice_getReputationScore", move |params: Params| {
