...
GUI_CONFIG_DIR="$HOME/Library/Application Support/lattice-core"
...
export LATTICE_GUI_CONFIG="$GUI_CONFIG_DIR/testnet-config.json"
export LATTICE_NETWORK="testnet"
export LATTICE_BOOTNODES="127.0.0.1:30303"
