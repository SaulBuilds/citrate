// Comprehensive integration tests for Lattice V3

use lattice_consensus::{GhostDag, DagStore, GhostDagParams};
...
use lattice_network::PeerManager;
...
mod integration_tests {
    ...
    async fn test_executor_state_persistence() {
        ...
        // First session - create state
        {
            ...
            let addr = lattice_execution::types::Address([1u8; 20]);
    ...
    async fn test_network_and_consensus_integration() {
        ...
        let msg = lattice_network::NetworkMessage::NewBlock {
            block: block.clone()
        };
